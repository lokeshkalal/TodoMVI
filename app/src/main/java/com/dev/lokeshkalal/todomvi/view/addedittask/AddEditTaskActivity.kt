...
class AddEditTaskActivity : AppCompatActivity(),
    ...
    EventObservable<AddEditTaskViewEvents> {
     ...
     */
    private val navigateUpRelay = PublishRelay.create<AddEditTaskViewEvents.CancelTaskClick>()
    ...
    override fun events(): Observable<AddEditTaskViewEvents> {
        return Observable.merge(
            toolbar.itemClicks()
                ...
                .map { AddEditTaskViewEvents.DeleteTaskClick },
            fab_edit_task_done.clicks().map { AddEditTaskViewEvents.SaveTaskClick },
            navigateUpRelay
        )
    }
    ...
    override fun onSupportNavigateUp(): Boolean {
        navigateUpRelay.accept(AddEditTaskViewEvents.CancelTaskClick)
        return true
    }
